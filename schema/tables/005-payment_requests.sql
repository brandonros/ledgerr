CREATE TABLE IF NOT EXISTS payment_requests (
    ...
    from_account_id INTEGER REFERENCES payment_accounts(account_id),
    to_account_id INTEGER REFERENCES payment_accounts(account_id),
    amount DECIMAL(15,2),
...
CREATE INDEX IF NOT EXISTS idx_payment_requests_accounts ON payment_requests(from_account_id, to_account_id);